...
def combine_foods():
    ...
    for food in foods:
        meal += food + ' '
    return meal.strip()  # Remove the trailing space
# Call the function and print the result
...
# Use a for loop tor  iterate ovethe key: value pairs in the home_town dictionary and append a string with the following format to home_town_items: "<key> = <value>"
